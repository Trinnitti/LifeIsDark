...
public class PrikazJdi implements IPrikaz {
     ...
     *  (východ) není, vypíše se chybové hlášení.Pokud je prosotr zamčený, taktéž
     *  se to vypíše hráči.
     *
    ...
    public String provedPrikaz(String... parametry) {
        ...
        if (sousedniProstor == null) {
            return "Tam se odsud nedostaneš. Zkus to jinudy.";
        }
        else {
            if (sousedniProstor.jeZamceno()) {
                //pokud je sousedni místnost zamčená
                return "Je zamčeno, musíš nejdřív najít správný klíč";
            }
